...
function SocialLogin() {
  ...
  return (
    <>
      <div className="social-login flex flex-col md:flex-row justify-center gap-4">
        <button
          onClick={googleLogin}
          className="text-sm text-neutral-400 bg-neutral-800 w-full p-4 flex gap-2 justify-center items-center rounded-md border border-neutral-600 hover:bg-neutral-600 cursor-pointer"
        >
