...
function Register() {
    ...
    return (
        <form onSubmit={registerHandler} className='flex flex-col gap-4 bg-neutral-700 p-6 max-w-lg  md:p-8 rounded-2xl border border-neutral-600 mx-2'>
            ...
            <div className="name flex gap-4 flex-col md:flex-row">
                <div className="first-name-input-field flex flex-col gap-2 my-1">
                    <label htmlFor="firstName" className='text-sm font-medium'>Your First Name</label>
                    <input
                        type="text"
                        name="firstName"
                        id="firstName"
                ...
                <div className="last-name-input-field flex flex-col gap-2 my-1">
                    <label htmlFor="lastName" className='text-sm font-medium'>Your Last Name</label>
                    <input
                        type="text"
                        name="lastName"
                        id="lastName"
            ...
            <button type='submit' className='bg-emerald-600 p-2 rounded-md my-2 font-medium cursor-pointer hover:bg-emerald-700 flex gap-2 justify-center items-center'>Create an account {isLoading ? <LuLoaderCircle className='text-xl animate-spin' /> : ""} </button>
            <div className='flex flex-wrap gap-1 text-sm text-neutral-400'>
                <div className='text-nowrap'>Already have an account?</div>
                <Link to={"/login"}><span className='text-emerald-600 font-medium hover:underline cursor-pointer' >Login</span></Link>
            </div>
        </form>
    )
}
