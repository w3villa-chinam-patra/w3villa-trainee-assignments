...
function MovieDetails() {
  ...
  return (
    isLoading
      ?
      <section className='movie-details-section-shimmer relative h-full w-full border border-neutral-700 rounded-2xl overflow-y-auto'>
        ...
        <div className="movie-details absolute inset-0">
          <div className="grid grid-cols-[auto_1fr] h-full">
            <div className="movie-poster flex items-center w-sm px-6">
              <div className="poster-container relative w-full">
                <div className='w-full rounded-2xl border border-neutral-600 shadow-2xl shadow-neutral-500 h-full'>hel</div>
            ...
            <div className="movie-info flex items-center text-white p-4 h-full">
              <div className="movie-info-wrapper my-auto">
                <div className="movie-title-ratings flex justify-between gap-2 items-center my-4">
                  <div className="movie-title flex flex-col items-start">
                    <div className="title text-5xl font-black">{data?.title}</div>
                    <div className="movie-tagline my-2 text-xl font-medium">{data?.tagline}</div>
                    <div className="release-date px-4 py-1 bg-white/30 rounded-full backdrop-blur-3xl my-2">
                  ...
                  <div className="review flex items-center gap-2 px-4 py-1 bg-white/30 rounded-full backdrop-blur-3xl">
                    <div className="star-container w-6">
                      <img src="/assets/star.png" alt="star" className='w-full' />
                    </div>
                    <div className="rating text-lg mt-1">{data?.vote_average.toFixed(1)}</div>
                  </div>
                </div>
                <div className="genres my-2 flex flex-wrap gap-4 items-center text-nowrap">
                  {
                    data?.genres.map((genres) => {
                      return <div key={genres.id} className='px-4 py-1 text-sm backdrop-blur-3xl rounded-full border border-neutral-600'>{genres.name}</div>
                    }
                    )
                  }
                </div>
                ...
                <div className="production-companies">
                  <h2 className='text-2xl font-semibold my-2'>Production Companies</h2>
                  <div className="logo-container flex flex-wrap gap-6 my-4">
                    {
      ...
      :
      <section className='movie-details-section relative h-full w-full border border-neutral-700 rounded-2xl overflow-y-auto'>
          ...
          <div className="flex flex-col items-center md:grid md:grid-cols-[auto_auto] h-full">
            ...
            <div className="movie-info flex items-center text-white p-2 lg:p-4 h-full">
              <div className="movie-info-wrapper my-auto">
                ...
                <div className="overview text-sm lg:text-base">
                  <h2 className='text-xl lg:text-2xl font-semibold my-2'>Overview</h2>
                  {data?.overview}
                </div>
                <div className="production-companies">
