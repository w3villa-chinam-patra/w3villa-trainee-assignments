  ...
  return (
    <div className="flex flex-col bg-neutral-200 dark:bg-neutral-900 py-2 px-2 sm:px-6 text-sm sm:text-base rounded-2xl gap-4">
      ...
      <div className="choose-language flex items-center justify-between">
        ...
        <div className="options flex gap-2 flex-wrap">
          <div className="px-2 py-1 bg-neutral-300 dark:bg-neutral-800 flex items-center justify-center rounded-full border border-neutral-400 dark:border-neutral-700 cursor-pointer hover:bg-neutral-400 dark:hover:bg-neutral-600">
            English
          </div>
          <div className="px-2 py-1 bg-neutral-300 dark:bg-neutral-800 flex items-center justify-center rounded-full border border-neutral-400 dark:border-neutral-700 cursor-pointer hover:bg-neutral-400 dark:hover:bg-neutral-600">
            Spanish
